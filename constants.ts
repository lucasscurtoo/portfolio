...
export const experience = [
  {
    imageSrc:
      "https://blog.moove-it.com/wp-content/uploads/2018/07/Moove-It-Logo-Lockup-Dark-1.png",
    position: "Apprentice",
    companyName: "Moove-It",
    techUsed: [
      {
        name: "JavaScript",
    ...
    tasks: [
      "Javascript, React, Python and Django Rest onbordings",
      "I work for the principal page making the about us section",
    ],
  },
  {
    ...
    tasks: [
      "Make custom software such as software for automotive mechanics",
      "Develop an mobile application for baby's care",
    ],
  },
]
...
export const projects = [
  {
    ...
    hint: "To-Do List is a project that simply allows the user to make lists of to-do's tasks.This project was made to understand in deep how nextjs, redux-toolkit and rtk-query works, also to know how to deploy apps",
    description:
      "To-Do List is a project that simply allows the user to make lists of to-do's tasks.This project was made to understand in deep how nextjs, redux-toolkit and rtk-query works, also to know how to deploy apps.Please take a see that the first request that is made to the server, it's going to take up to 30 seconds to be successful, that's because Render Web Services on the free instance type are automatically spun down after 15 minutes of inactivity",
    sourceCode: "https://github.com/lucasscurtoo/to-do-webApp",
    deployedApp: "https://lucascurto-todo.netlify.app/",
  },
  {
    title: "Netflix clone",
    src: "/netflixLogo.png",
    hint: "This is a netflix clone, this project was made to understand how next-auth, prismadb, the api next.js folder works,  and introduce myself into typescript.",
    description:
